...
export const Navbar = ({ navLinks }: NavbarProps) => {
  ...
  return (
    <div className='fixed bottom-0 left-0 z-40 flex w-full justify-center lg:static lg:bottom-5 lg:w-auto print:hidden'>
      <nav className='flex w-full flex-row justify-center gap-3 bg-white py-2 md:gap-5 lg:w-auto lg:gap-2 lg:rounded-full lg:bg-transparent dark:bg-black dark:lg:bg-transparent'>
