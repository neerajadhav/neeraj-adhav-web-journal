...
export const SingleBlog = (props: SingleBlogProps) => {
  ...
  return (
    <Link
      href={`/${slug}`}
      className='group w-full items-center border-b border-gray-300 p-4 py-6 text-gray-950 last:border-b-0 dark:border-gray-700 md:w-1/3 lg:border-0 lg:border-t-0 lg:py-4'
    >
