...
const PageSection: React.FC<PageSectionProps> = ({ title, children, link }) => {
  return (
    <section className='flex flex-col items-start border bg-white text-gray-950 dark:border dark:border-gray-800 dark:bg-gray-900 dark:text-zinc-300'>
      <div className='flex w-full flex-row items-center justify-between border-b px-4 py-3 lg:py-4 dark:border-gray-800'>
