...
const Newsletter = () => {
  return (
    <section>
      <div className='mx-auto mt-2 flex flex-col items-center justify-center gap-3 border-y border-gray-700 pb-5 pt-3 lg:flex-row lg:pt-5'>
        ...
        <form className='flex w-full items-center gap-1'>
          <input
            ...
            disabled
            className='w-19/20 h-10 flex-1 rounded-lg border border-gray-700 px-2 focus:outline-none focus:ring-1 focus:ring-blue-500'
          />
          <button
            type='submit'
            disabled
