...
import handleMathJax from '../../../public/utils/handle-math-jax';
import { resizeImage } from '../../../public/utils/image';
import { loadIframeResizer } from '../../../public/utils/services/embed';
import { triggerCustomWidgetEmbed } from '../../../public/utils/trigger-custom-widget-embed';
    ...
    <Container>
      ...
      >
        <article className='relative'>
          {post.coverImage?.url && (
            <div
              className='absolute z-10 h-32 w-full blur-[200px] lg:blur-[250px]'
              style={{
