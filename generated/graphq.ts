...
export type PublicationQuery = {
  ...
  publication?: {
    ...
    preferences: { __typename?: 'Preferences'; logo?: string | null };
...
export const useStaticPageQuery = <TData = StaticPageQuery, TError = unknown>(
  ...
  return useQuery<StaticPageQuery, TError, TData>({
    ...
    queryFn: fetchData<StaticPageQuery, StaticPageQueryVariables>(
      StaticPageDocument,
      variables
    ),
    ...options,
...
useStaticPageQuery.getKey = (variables: StaticPageQueryVariables) => [
  'StaticPage',
  variables,
];
...
>(
  variables: StaticPageQueryVariables,
  options: Omit<
    UseInfiniteQueryOptions<StaticPageQuery, TError, TData>,
    'queryKey'
  > & {
    queryKey?: UseInfiniteQueryOptions<
      StaticPageQuery,
  ...
  return useInfiniteQuery<StaticPageQuery, TError, TData>(
    (() => {
      ...
      return {
        ...
        queryFn: (metaData) =>
          fetchData<StaticPageQuery, StaticPageQueryVariables>(
            StaticPageDocument,
            { ...variables, ...(metaData.pageParam ?? {}) }
          )(),
        ...restOptions,
...
useInfiniteStaticPageQuery.getKey = (variables: StaticPageQueryVariables) => [
  'StaticPage.infinite',
  variables,
];

useStaticPageQuery.fetcher = (
  variables: StaticPageQueryVariables,
  options?: RequestInit['headers']
) =>
  fetchData<StaticPageQuery, StaticPageQueryVariables>(
